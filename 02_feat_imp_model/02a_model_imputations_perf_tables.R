...
fils <- list.files(path_wd("04_outputs", "imputations"), 
...
write.csv(boruta_data, file = path_wd("04_outputs", "boruta_IMP_summary_feature_reduction",
                                      ext = "csv"), row.names = FALSE)
saveRDS(boruta_data, file = path_wd("04_outputs", "boruta_IMP_summary_feature_reduction",
                                    ext = "rds"))
...
feat_imp_fils <- list.files(path_wd("04_outputs", "imputation"), 
...
feat_all_data <- feature_data |>
  ...
  nest() |>
  mutate(tbl_path = path_wd("04_outputs", str_glue("{fil_name}_{boruta_method}_IMP_features"), ext = "csv"))
...
write.csv(boruta_feat_reduct, file = path_wd("04_outputs", 
                                             "boruta_IMP_feature_reduction_percentage",
                                      ext = "csv"), row.names = FALSE)
